...
from hyprl.model.probability import ProbabilityModel, maybe_calibrate
...
def prepare_supercalc_dataset(
    ...
    *,
    ...
    calibrator_path = config.calibration_artifact_path
    ...
    if fast and artifact_path:
        ...
        try:
            ...
            if not design_slice.empty:
                ...
                if calibrator_path:
                    proba_all = maybe_calibrate(proba_all, calibrator_path)
    ...
    for current_idx in range(min_history, len(features)):
        ...
        if prob_map:
            ...
            if calibrator_path:
                probability_up = float(maybe_calibrate([probability_up], calibrator_path)[0])
        timestamp = feature_index[current_idx]
