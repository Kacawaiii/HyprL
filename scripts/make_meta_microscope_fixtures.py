...
"""Generate META microscope fixtures (backtest vs replay) for parity tests."""
...
BT_LOG = PARITY_DIR / "meta_backtest_signal_log_MICRO.csv"
REPLAY_LOG = PARITY_DIR / "meta_replay_signal_log_MICRO.csv"
DIFF_LOG = PARITY_DIR / "meta_signal_diff_MICRO.csv"
REPLAY_TRADES = PARITY_DIR / "meta_replay_trades_MICRO.csv"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Generate META microscope parity fixtures.")
    ...
    print(f"[parity] Running META backtest {START} → {END}")
    ...
    print("[parity] Running META replay")
