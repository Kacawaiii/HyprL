...
def _install_fake_alpaca(monkeypatch) -> None:
    ...
    class TakeProfitRequest(_BaseRequest):
        pass

    class StopLossRequest(_BaseRequest):
        pass
    ...
    requests.TakeProfitRequest = TakeProfitRequest
    requests.StopLossRequest = StopLossRequest
    ...
    enums.OrderClass = AlpacaOrderClass

    # Add data module mocks
    ...
    class StockHistoricalDataClient:
        ...
        def get_stock_latest_trade(self, request):
            return {"NVDA": types.SimpleNamespace(price=150.0)}
